                    ...
                    <SwiperSlide key={index}>
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{
                                ...
                                paddingX: "30px", color: "text.primary", width: { sm: "unset", md: "30%", lg: "40%" }
                            }}>
                                <Stack spacing={4} direction="column">
                                    {/* title */}
                                    <Typography variant='h4' fontSize={{ xs: "2rem", md: "2rem", lg: "4rem" }}
                                        fontWeight="700" sx={{ ...uiConfigs.style.typoLines(2, "left") }}
                                    >
                                    ...
                                    <Stack direction="row" spacing={1} alignItems="center">
                                        ...
                                        <Divider orientation='vertical' >
                                            ...
                                            {[...movie.genre_ids].splice(0, 2).map((genreId, index) => (
                                                <Chip variant='filled' color="primary" key={index} sx={{ margin: "0 4px" }}
